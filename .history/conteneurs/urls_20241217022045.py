...
urlpatterns=[
        ...
        path('iso/<int:pk>/modifier/', IsoUpdateView.as_view(), name='modifier_iso'),

    # URL pour la suppression d'un conteneur IsoTanks
        path('iso/<int:pk>/supprimer/', IsoDeleteView.as_view(), name='supprimer_iso'),
