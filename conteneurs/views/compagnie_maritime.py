...
from conteneurs.models import CompagnieMaritime,Pays 
...
class CompagnieMaritimeView( ListView):
    ...
    def get_queryset(self):
        ...
        pays_id = self.request.GET.get('pays')  # Récupérer le paramètre pays de l'URL

        if search:
            queryset = queryset.filter(
                Q(nom_compagnie_maritime__icontains=search) | 
