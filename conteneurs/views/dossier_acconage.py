...
# You can now continue with the rest of your code to generate the PDF content.
    ...
    if dossier.type_conteneur == 'ISO_20_pieds':
        ...
        data = [["N°", "Réf", "État", "P.net", "N°plomb 1", "N°plomb 2", "N°plomb 3", "N°plomb 4", "N°plomb 5"]]
        for i, conteneur in enumerate(conteneurs, start=1):
            data.append([
                ...
                conteneur.numero_plomb4 or "N/A",  # Nouvelle colonne pour numero_plomb2
                conteneur.numero_plomb5 or "N/A"   # Nouvelle colonne pour numero_plomb3
            ])
    else:
        # Tableau par défaut pour d'autres types de conteneurs
        data = [["N°", "Réf", "État", "P.brute", "P.équipement", "P.net", "heating pad", "flexitank", "plomb", "plomb 2", "plomb 3"]]
        for i, conteneur in enumerate(conteneurs, start=1):
            data.append([
                i,
                conteneur.reference or "N/A",
