...
class IsoTanks(SafeDeleteModel,LifecycleModel):
    ...
    numero_plomb1 = models.CharField(max_length=50, blank=True, null=True)
    photo_plomb1 = models.ImageField(upload_to='photos_plomb1/', blank=True, null=True)
    ...
    dossier = models.ForeignKey(Dossier, related_name='Iso_tanks',on_delete=models.CASCADE)
    agent_selection = models.ForeignKey(Personnel, limit_choices_to={'Personnel_type': 'agent_selection'}, on_delete=models.CASCADE, related_name='isotanks_selection')
    agent_acconage = models.ForeignKey(Personnel, limit_choices_to={'Personnel_type': 'agent_acconage'}, on_delete=models.CASCADE, related_name='isotanks_acconage', null=True, blank=True)
    Date_ajout = models.DateTimeField(default=timezone.now, editable=False)
    ...
    def calcule_poid_brute(self):
        self.poids_brute = self.poids_net 
    def save(self, *args, **kwargs):
        self.calcule_poid_brute()
        super(IsoTanks, self).save(*args, **kwargs)
